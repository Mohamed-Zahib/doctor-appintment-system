...
?>
                ...
                <?php
                    if($_POST){
                        ...
                        $sql="SELECT COUNT(*) FROM schedule INNER JOIN doctor ON schedule.docid = doctor.docid INNER JOIN appointment ON appointment.scheduleid = schedule.scheduleid where docid='$userid';";
