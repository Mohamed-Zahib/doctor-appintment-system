...
<body>
 ...
 <div class="container">
     ...
     <table class="menu-container" border="0">
        ...
        <?php
                $sqlmain= "select * from schedule inner join doctor on schedule.docid=doctor.docid where schedule.scheduledate>='$today' and endscheduletime>'$now' order by schedule.scheduledate asc;";
                $sqlpt1="";
                $insertkey="";
                $q='';
                $searchtype="All";
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<($result->num_rows);$x++){
                                    ...
                                    for($q=0;$q<3;$q++){
                                        ...
                                        $endscheduletime=$row["endscheduletime"];

                                        if($scheduleid==""){
                                            break;
                                        }
                                        //total appointments for doctor
                                     // $sql="select nop from schedule inner join doctor on schedule.docid=doctor.docid where schedule.scheduleid=$id";
                                     // $result13=$database->query($sql);
                                     // $result=$result13->fetch_assoc();
                                     // $appmax=$result["nop"];
                                        // $sql="select "
                                        echo '
                                        <td style="width: 25%;">
