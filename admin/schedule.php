            ...
            <table class="menu-container" border="0">
				...
				<tr class="menu-row" >
                    <td class="menu-btn menu-icon-schedule">
                        <a href="report.php" class="non-style-link-menu"><div><p class="menu-text">Report</p></div></a>
                    </td>
                </tr>
            </table>
        </div>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        echo     '       </select><br><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="time" class="form-label">Schedule Start Time: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="time" name="stime" class="input-text" placeholder="Start Time" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="time" name="etime" class="input-text" placeholder="End Time" required><br>
                                </td>
                            </tr>
